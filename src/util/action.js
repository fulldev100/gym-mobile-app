...
export const personalEntryAction = (data) => {
    return defaultRestClient.postWithBody(PERSONAL_ENTRY, data);
}

export const postMembershipAction = (data) => {
    return defaultRestClient.postWithBody(BUY_MEMBERSHIP, data);
}

export const postProductAction = (data) => {
    return defaultRestClient.postWithBody(BUY_PRODUCT, data);
}
...
// For Admin
export const adminDashboardAction = (data) => {
    return defaultRestClient.postWithBody(ADMIN_DASHBOARD, data);
}

export const adminDashboardEntryAction = (data) => {
    return defaultRestClient.postWithBody(ADMIN_DASHBOARD_ENTRY, data);
}

export const adminDashboardSailAction = (data) => {
    return defaultRestClient.postWithBody(ADMIN_DASHBOARD_SAIL, data);
}